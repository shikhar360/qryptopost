    ...
    <div className={`w-[90%] min-h-screen pt-40 mx-auto`}>
      ...
      <div className={`grid grid-cols-3 mt-20`}>
        <div className={`w-[80%] h mx-auto shadow-lg shadow-black/10 rounded-xl flex flex-col items-center justify-start px-8 py-10 `}> 
          ...
          <p className={`text-sm text-black/50 pt-5 text-center`}>The Qryptomail is completely secure with the the cutting edge tecnology of blockchain </p>
        </div>
        <div className={`w-[80%] h mx-auto shadow-lg shadow-black/10 rounded-xl flex flex-col items-center justify-start px-8 py-10 `}> 
          ...
          <p className={`text-sm text-black/50 pt-5 text-center`}>The Qryptomail is built keeping in mind that a 5 year old can also use that with super ease </p>
        </div>
        <div className={`w-[80%] h mx-auto shadow-lg shadow-black/10 rounded-xl flex flex-col items-center justify-start px-8 py-10 `}> 
          ...
          <p className={`text-sm text-black/50 pt-5 text-center`}>Qryptomail mainly focus on how fast we can execute a operation. This is mainly done to improve the user experience</p>
        </div>
      </div>
    </div>
  )
