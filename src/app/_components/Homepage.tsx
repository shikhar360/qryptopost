...
const Homepage = () => {
  return (
    <div className={`w-full min-h-screen flex flex-col items-center justify-start `}>
      <section className={`w-[96%] md:w-[90%] min-h-[85vh] flex flex-col items-start justify-start px-20  bg-[#661EFE] text-white pt-24 pb-10 rounded-[4rem] font-mooli relative`}>
       ...
       <button className={`bg-[#64FCDA] rounded-full px-8 py-3  mt-6 text-black font-semibold `}>TRY OUT NOW</button>
      ...
      <Powered/>
      <Feature/>
      <section className={`w-[96%] md:w-[90%] min-h-[45vh] grid md:grid-cols-[1fr_3fr] grid-cols-1 px-20  bg-[#661EFE] text-white py-24  mt-20 rounded-[4rem] font-mooli relative`}>
      <img src="/img/mail2.png" alt="mailbox" className={`float-right mix-blend-screen  w-full select-none`} draggable='false' />
       <div className={`px-20`}>
        <h1 className={`text-4xl text-[#64FCDA] font-bold mb-5`}>Embark on a Web3 Odyssey with Qryptomail</h1>
        ...
        <button className={`bg-[#64FCDA] rounded-full px-8 py-3  mt-6 text-black font-semibold `}>IT&apos;S FREE</button>
       </div>
      </section>
     <FAQ/>
    </div>
